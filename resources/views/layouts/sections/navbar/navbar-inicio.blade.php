...
<nav class="layout-navbar {{$containerNav}} navbar navbar-expand-xl {{$navbarDetached}} align-items-center bg-navbar-theme" id="layout-navbar">
  ...
  <nav class="layout-navbar navbar navbar-expand-xl align-items-center bg-navbar-theme" id="layout-navbar">
    <div class="{{$containerNav}}">
      ...
      <img width="170px" src="{{asset('assets/img/logos/LogoSIGLESIA.png')}}">
      @endif
    ...
    <div style="padding-top: 17px;">
      <p>Bienvenido a <b>SIGLESIA</b>, hoy es <b id="current-date"></b> y son las <b id="current-time"></b></p>
    </div>
    <!-- /Search -->
      @endif
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        <!-- Search @if(isset($menuHorizontal))
          ...
          <div class="dropdown-menu dropdown-menu-end py-0">
            <div class="dropdown-menu-header border-bottom">
              <div class="dropdown-header d-flex align-items-center py-3">
                <h5 class="text-body mb-0 me-auto">Modulos</h5>
            ...
            <div class="dropdown-shortcuts-list scrollable-container">
              <div class="row row-bordered overflow-visible g-0">
                <div class="dropdown-shortcuts-item col">
                  ...
                  <a href="{{url('app/calendar')}}" class="stretched-link">Libros Parroquiales</a>
