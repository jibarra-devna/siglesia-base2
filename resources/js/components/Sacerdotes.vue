<template>
  <div style="display:grid;grid-template-columns: 1fr 1fr;grid-gap:1.25rem">
    ...
    <div style="text-align: right;">
      ...
      <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#agregarEditarModal" style="justify-content: flex-end;" @click="openModal('add')">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">{{ modalType === 'add' ? 'Agregar Sacerdote' : 'Editar Sacerdote' }}</h5>
              ...
              <div class="row">
                  ...
                  <div class="row">
                    ...
                    <div class="col mb-3">
                      ...
                      <input type="date" v-model="sacerdote.fecha_nacimiento" class="form-control" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col mb-3">
                      <label for="nameBackdrop" class="form-label">Inicio de Periodo</label>
                      <input type="date" v-model="sacerdote.periodo_inicio" class="form-control" required>
                    </div>
                    <div class="col mb-3">
                      <label for="nameBackdrop" class="form-label">Fin de Periodo</label>
                      <input type="date" v-model="sacerdote.periodo_fin" class="form-control" required>
                    </div>
                  </div>
          </div>
...
export default {
  data() {
    return {
      ...
      modalType: '',
      deleteId: null,
      titulos: ['Padre', 'Monseñor', 'Obispo', 'Nuncio', 'Pbro.'] // Opciones para el select
    };
  },
  methods: {
    fetchSacerdotes() {
